...
const AddProfessorForm = (props: {
  ...
  return (
    <form
      ...
      className="p-3 shadow-lg bg-gradient-to-tr from-slate-600 to-green-500 rounded-lg"
    >
      <div className=" text-white text-center font-bold text-xl p-10">
        Add a Professor
      </div>
      <div className="m-3">
        <label htmlFor="firstName" className="text-md text-white">
          First Name
        </label>
        <input
      ...
      <div className="m-3">
        <label htmlFor="lastName" className="text-md text-white">
          Last Name
        </label>
        <input
          className="input-primary"
      ...
      <div className="m-3">
        <label className="text-md text-white">Department</label>
      ...
      <div className="m-3">
        <label className="text-md text-white">University</label>
